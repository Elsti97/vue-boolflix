<template>
  <div>
    <div class="card">
      {{starsRating()}}
      <img
        v-if="singleSerie.poster_path"
        :src="`http://image.tmdb.org/t/p/w342/${singleSerie.poster_path}`"
        alt="copertina serie"
      />
      ...
      <div class="titles">
        ...
        <img
          v-if="flags.includes(singleSerie.original_language)"
          :src="require(`../assets/${singleSerie.original_language}.svg`)"
          class="flag"
        />
        <p v-else>
          Lingua Originale: {{ singleSerie.original_language.toUpperCase() }}
        </p>
        <div class="d-flex">
